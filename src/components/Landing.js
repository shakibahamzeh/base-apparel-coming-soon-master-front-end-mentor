  ...
  return (
    <>
        <section className='leftContainer'>
          ...
          <div className='picMobileContainer'>
        ...
        <main>
           ...
           <div className='title'>
                ...
                <div className='content'>
                    <p>Hello fellow shopper! We're currently building our new</p>
                    <p>fashion store. Add your email below to stay up-to-date with</p>
                    <p>announcements and our launch deals.</p>
                </div>
           </div>
           <form>
                <div className={(errors.email && touched.email) ? "formInputContainerUnCompleted"  : "formInputContainer"}>
                  <input type="email" name="email" placeholder='Email Address' onChange={changeHandler} onFocus={focusHandler} className={(errors.email && touched.email) ? "uncompleted"  : "formInput"}/>
                ...
                <div className='formControl'>
                   <button type='submit' className={(errors.email && touched.email) ? "uncompletedBtn"  : "btn"}>
